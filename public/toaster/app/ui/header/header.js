(function() {
  ...
  __t('app.ui.header').Header = (function() {
    ...
    function Header(canvas_id) {
      ...
      this.intro.add(new AnimText("011010101101101001", "#e54c6b", 150, 182));
      this.intro.add(new AnimText("C:CODEMAN/WEBSITE", "#000", 140, 25));
      this.intro.add(new AnimText("CREATIVE CODER", "#000", 257, 90));
      ...
      this.intro.add(new Drop(60, 140, 1));
      this.intro.add(new Drop(43, 122, 0.6));
      this.intro.add(new Drop(90, 125, 0.6));
